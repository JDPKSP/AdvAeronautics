...
namespace AdvAeronautics {
    public class ModuleWingAnimated : PartModule {
        [KSPField]
        ...
        private List<Transform> mirrorTransforms {
            get {
                ...
                AAeroUtil.findTransformsWithPrefix(part.transform, ref tmp, mirrorTransformPrefix);
                return tmp;
            }
        }
        ...
        [KSPEvent(name = "Mode0Event", guiActive = true, guiName = "Mode1", guiActiveEditor = true)]
        ...
        [KSPEvent(name = "Mode1Event", guiActive = true, guiName = "Mode1", guiActiveEditor = true)]
